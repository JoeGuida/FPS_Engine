...
public:
	Rectangle(float x, float y, const Material& material, const Transform& transform) 
	: size(x, y), material(material), transform(transform) {
		vertices = {
	...
	Rectangle(float x, const Material& material, const Transform& transform)
